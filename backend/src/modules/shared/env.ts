...
const envSchema = z.object({
  ...
  ELEVENLABS_BASE_URL: z.string().optional(),
  ...
  FACEBOOK_OAUTH_SCOPES: z.string().optional(),
  INSTAGRAM_OAUTH_SCOPES: z.string().optional(),
  MESSENGER_OAUTH_SCOPES: z.string().optional(),
  WHATSAPP_OAUTH_SCOPES: z.string().optional(),
  // Instagram
